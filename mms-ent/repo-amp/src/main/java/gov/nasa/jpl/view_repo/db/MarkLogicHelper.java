...
public class MarkLogicHelper implements DocStoreHelperInterface
{
	private static Logger logger = Logger.getLogger(MarkLogicHelper.class);
	
	Map<String, MarkLogicDBInfo> dbInfo;
	private MarkLogicRestClient mainRestClient = null;
	
	public MarkLogicHelper()
	{
