...
usageText = '''    
    To create 50 elements with 2 changes posting 5 at a time under two refs:
    ...
    To create 500 elements with 4 changes posting 10 at a time under three refs with a branching factor of 2:
...
parser.add_option("-w", "--refs", default="master", help="A string of comma separated workspace names to be used i.e. \"workspace1,workspace2,workspace3...\" (no spaces) DEFAULT: master")
...
parser.add_option("-x", "--execute", dest="execute", action="store_true", default=False, help="Execute the commands to create refs and post the elements")
